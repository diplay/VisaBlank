...
class ForeignPassportData < ActiveRecord::Base
  ...
  def get_attributes
    ...
    r_attr[:passport_number_series] = client.passport_number_series
    r_attr[:passport_number] = client.passport_number
    r_attr[:passport_given] = client.passport_given #+ "код подразделения: " + client.passport_given_code
    r_attr[:passport_given_date_day] = client.passport_given_date.mday
    r_attr[:passport_given_date_month] = passport_given_date_month
    r_attr[:passport_given_date_year] = client.passport_given_date.year
